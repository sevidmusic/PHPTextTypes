...
use \Darling\PHPTextTypes\interfaces\collections\IdCollection;
use \Darling\PHPTextTypes\classes\strings\Id;

/**
 * The IdCollectionTestTrait defines common tests for
 * implementations of the IdCollection interface.
 *
 * @see IdCollection
 *
 */
trait IdCollectionTestTrait
{
    ...
    /**
     * @var IdCollection $idCollection An instance of a
     *                                     IdCollection
     ...
     *                           The array of Id instances that
     *                           is expected to be returned by the
     *                           IdCollection instance being
     ...
     *
     * This method must set the IdCollection implementation
     * instance to be tested via the setIdCollectionTestInstance()
     * method.
     *
     ...
     *         [
     *             new Id(new Text($this->randomChars())),
     *             new Id(new Text($this->randomChars())),
     *             new Id(new Text($this->randomChars())),
     *             new Id(new Text($this->randomChars())),
     *             new Id(new Text($this->randomChars())),
     ...
     *
     * @param IdCollection $idCollectionTestInstance An instance
     *                                                  of an
     *                                                  implementation
     *                                                  of the
     *                                                  IdCollection
    ...
    /**
     * Set the array of Id instances that is expected to be
